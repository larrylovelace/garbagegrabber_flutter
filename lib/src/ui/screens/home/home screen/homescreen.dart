                  ...
                  slivers: [
                    SliverList(
                      delegate: SliverChildListDelegate([
                        products.upComingPickupData.isEmpty
                            ? Container(
                                    ...
                                    children: [
                                                        ...
                                                        Row(
                                                          children: [
                                                            ...
                                                            Text(
                                                                ...
                                                                "(${products.upComingPickupData[0].plan})",
                                                                style: AppFonts
                                                                    .poppinsMedium
                                                                    .copyWith(
                                                                        fontSize:
                                                              ...
                                                              children: [
                                                                ...
                                                                Row(
                                                                  children: [
                                                                    Text(
                                                                        int.parse(
                                                                                  products.upComingPickupData[0].remainingDays,
                                                                                ) >
                                                                                1
                                                                            ? 'Days left'
                                                                            : 'Day left',
                                      ...
                                      Expanded(
                                        child: ListView.builder(
                                            ...
                                            itemCount: products
                                                .upComingPickupData[0]
                                                .pickUpDates
                                                .length,
                                            itemBuilder: (context, index) {
                                              final month = homecontroller
                                                  .dateConverter
                                                  .getMonthFromDate(products
                                                      .upComingPickupData[0]
                                                      .pickUpDates[index]
                                                      .pickUpDate);
