                        ...
                        delegate: SliverChildBuilderDelegate(
                          (context, index) {
                            String startdate = appointmentData
                                .activeAppointments[index].appointmentDateStart;
                            String enddate = appointmentData
                                .activeAppointments[index].appointmentDateEnd;
                            ...
                            int currentSelectedDate =
                                8; // Current date (example: 8th date)
...
// ...
                          ...
                          childCount: appointmentData.activeAppointments.length,
                        ),
                      ),
                    ],
                  ),
